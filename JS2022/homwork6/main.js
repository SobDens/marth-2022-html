...
// poker.forEach(function (poker){
// console.log()
// })
// poker.forEach((value,index) => console.log(value))

// - знайти піковий туз
// console.log(poker.filter(value =>value.cardSuit === 'spade' && value.value === 'ace'));

// - всі шістки
// console.log(poker.filter(value =>value.value === '6'));

// - всі червоні карти
// console.log(poker.filter(value =>value.color === 'red'));

// всі буби
// console.log(poker.filter(value => value.cardSuit === 'diamond'));

// - всі трефи від 9 та більше
// console.log(poker.filter(value => value.cardSuit === 'clubs' && value.value > '8'
